...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByVal7(StructSeqWithArrayField str1)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRef7(StructSeqWithArrayField* str1)
{
    if(!IsCorrectStructSeqWithArrayField(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefIn7(StructSeqWithArrayField* str1)
{
    if(!IsCorrectStructSeqWithArrayField(str1))
    {
        printf("\tManaged to Native failed in MarshalStructAsParam_AsSeqByRef7:StructSeqWithArrayField param not as expected\n");
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByValOut7(StructSeqWithArrayField str1)
{
    if(!IsCorrectStructSeqWithArrayField(&str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefOut7(StructSeqWithArrayField* str1)
{
    ChangeStructSeqWithArrayField(str1);
    return TRUE;
}
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByVal8(StructSeqWithEnumField str1)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRef8(StructSeqWithEnumField* str1)
{
    if(!IsCorrectStructSeqWithEnumField(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefIn8(StructSeqWithEnumField* str1)
{
    if(!IsCorrectStructSeqWithEnumField(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefOut8(StructSeqWithEnumField* str1)
{
    ChangeStructSeqWithEnumField(str1);
    return TRUE;
}
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByVal11(PritypeStructSeqWithUnmanagedType str1)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRef11(PritypeStructSeqWithUnmanagedType* str1)
{
    if(!IsCorrectPritypeStructSeqWithUnmanagedType(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefIn11(PritypeStructSeqWithUnmanagedType* str1)
{
    if(!IsCorrectPritypeStructSeqWithUnmanagedType(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByValOut11(PritypeStructSeqWithUnmanagedType str1)
{
    if(!IsCorrectPritypeStructSeqWithUnmanagedType(&str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefOut11(PritypeStructSeqWithUnmanagedType* str1)
{
    ChangePritypeStructSeqWithUnmanagedType(str1);
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByVal12(StructSequentialWithDelegateField str1)
{
    if(/*str1.i32 != 128 ||*/
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRef12(StructSequentialWithDelegateField* str1)
{
    if(/*str1->i32 != 128 ||*/
        str1->myDelegate1 == NULL)
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefIn12(StructSequentialWithDelegateField* str1)
{
    if( /* str1->i32 != 128 ||*/
        str1->myDelegate1 == NULL)
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByValOut12(StructSequentialWithDelegateField str1)
{
    if(/*str1.i32 != 128 ||*/
        str1.myDelegate1 == NULL)
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefOut12(StructSequentialWithDelegateField* str1)
{
    //str1->i32 = 256;
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByVal13(IncludeOuterIntergerStructSequential str1)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRef13(IncludeOuterIntergerStructSequential* str1)
{
    if(!IsCorrectIncludeOuterIntergerStructSequential(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefIn13(IncludeOuterIntergerStructSequential* str1)
{
    if(!IsCorrectIncludeOuterIntergerStructSequential(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByValOut13(IncludeOuterIntergerStructSequential str1)
{
    if(!IsCorrectIncludeOuterIntergerStructSequential(&str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefOut13(IncludeOuterIntergerStructSequential* str1)
{
    ChangeIncludeOuterIntergerStructSequential(str1);
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByVal14(StructSequentialWithPointerField str1)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRef14(StructSequentialWithPointerField* str1)
{
    if(str1->i32 != (LPINT)(16) || str1->i != 32)
        return FALSE;
    else
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefIn14(StructSequentialWithPointerField* str1)
{
    if(str1->i32 != (LPINT)(16) || str1->i != 32)
        return FALSE;
    else
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByValOut14(StructSequentialWithPointerField str1)
{
    if(str1.i32 != (LPINT)(16) || str1.i != 32)
        return FALSE;
    str1.i = 64;
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsSeqByRefOut14(StructSequentialWithPointerField* str1)
{
    str1->i32 = (LPINT)(str1->i);
    str1->i = 64;
    return TRUE;
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByValInnerExplicit1(InnerExplicit1 inner)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInnerExplicit1(InnerExplicit1* inner)
{
    if(!IsCorrectInnerExplicit1(inner))
    {
        printf("\tMarshalStructAsParam_AsSeqByRef: InnerSequential param not as expected\n");
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInInnerExplicit1(InnerExplicit1* inner)
{
    if(!IsCorrectInnerExplicit1(inner))
    {
        printf("\tMarshalStructAsParam_AsSeqByRefIn: InnerSequential param not as expected\n");
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByValOutInnerExplicit1(InnerExplicit1 inner)
{
    if(!IsCorrectInnerExplicit1(&inner))
    {
        printf("\tMarshalStructAsParam_AsSeqByValOut:NNER param not as expected\n");
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefOutInnerExplicit1(InnerExplicit1* inner)
{
    //change struct
    inner->f1 = 77;
    inner->f2 = 77.0;
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByValInnerExplicit2(InnerExplicit2 inner)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInnerExplicit2(InnerExplicit2* inner)
{
    if(inner->f1 != 1 || memcmp(inner->f3, L"some string",11) != 0)
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInInnerExplicit2(InnerExplicit2* inner)
{
    if(inner->f1 != 1 || memcmp(inner->f3, L"some string",11) != 0)
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefOutInnerExplicit2(InnerExplicit2* inner)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByValInnerArrayExplicit1(InnerArrayExplicit1 outer2)
{
    for(int i = 0;i<NumArrElements;i++)
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInnerArrayExplicit1(InnerArrayExplicit1* outer2)
{
    for(int i = 0;i<NumArrElements;i++)
    {
        if(outer2->arr[i].f1 != 1)
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInInnerArrayExplicit1(InnerArrayExplicit1* outer2)
{
    for(int i = 0;i<NumArrElements;i++)
    {
        if(outer2->arr[i].f1 != 1)
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefOutInnerArrayExplicit1(InnerArrayExplicit1* outer2)
{
    outer2->arr[0].f1 = 77;
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByValInnerArrayExplicit2(InnerArrayExplicit2 outer3)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInnerArrayExplicit2(InnerArrayExplicit2* outer3)
{
    if(!IsCorrectInnerArrayExplicit2(outer3))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInInnerArrayExplicit2(InnerArrayExplicit2* outer3)
{
    if(!IsCorrectInnerArrayExplicit2(outer3))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefOutInnerArrayExplicit2(InnerArrayExplicit2* outer3)
{
    ChangeInnerArrayExplicit2(outer3);
    return TRUE;
}
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByValNumberExplicit(NumberExplicit str1)
{
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefNumberExplicit(NumberExplicit* str1)
{
    if(!IsCorrectNumberExplicit(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefInNumberExplicit(NumberExplicit* str1)
{
    if(!IsCorrectNumberExplicit(str1))
    {
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalStructAsParam_AsExpByRefOutNumberExplicit(NumberExplicit* str1)
{
    ChangeNumberExplicit(str1);
...
extern "C" DLL_EXPORT BOOL WINAPI MarshalRecursivelyImportedStruct(RecursivelyImportedStruct ris)
{
	return TRUE;
}